...
/***/ function(module, exports, __webpack_require__) {
	...
	_Vue2.default.use(_vueRouter2.default); // src/index.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zhanglin/Desktop/Code/vue-github-users/src/components/App.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/zhanglin/Desktop/Code/vue-github-users/src/components/Home.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    methods: {
	        submit: function submit() {
	            ...
	            this.show = true;
	            this.$http.get('https://api.github.com/users/' + this.username + '/repos', function (data) {
	                // console.log(data)
	                _this.list = data;
	            }).error(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/zhanglin/Desktop/Code/vue-github-users/src/components/Users.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-156e51f7&file=Users.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Users.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-156e51f7&file=Users.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Users.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/zhanglin/Desktop/Code/vue-github-users/src/components/Repos.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    methods: {
	        getRepos: function getRepos() {
	            ...
	            this.$http.get('https://api.github.com/users/lingmm/repos', function (data) {
	                _this.repos = data;
	            }).error(function (err) {
	                return console.log(err);
	            });
	        },
	        getMyRepos: function getMyRepos() {
	            var _this2 = this;

	            this.$http.get('https://api.github.com/users/Axhello/repos', function (datas) {
	                _this2.myrepos = datas;
	            }).error(function (err) {
	                return console.log(err);
	            });
	        }
